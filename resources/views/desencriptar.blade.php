...
<body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        ...
                        <a href="{{ url('/desencriptar') }}" class="nav-item nav-link active">Desencriptar</a>
                ...
                <div class="container my-5 py-5 px-lg-5">
                    <div class="row g-5 py-5">
                        <div class="col-12 text-center">
                            <h1 class="text-white animated slideInDown">Descencriptar</h1>
                            <hr class="bg-white mx-auto mt-0" style="width: 100px;">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <a href="{{ url('/historial') }}">Ver Historial de Archivos Encriptados</a>
</div>
